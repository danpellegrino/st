...
static char *font2[] = {
	"Noto Color Emoji:pixelsize=22:antialias=true:autohint=true",	// Emojis
	"IPAGothic:pixelsize=22:antialias=true:autohint=true"		// Japanese
...
static const char *colorname[] = {
	...
	"#212736", /* default background colour */
};
